          ...
          <div className="md:col-span-4 md:ml-8">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <a href="https://www.linkedin.com/company/kersten-talent-capital/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-[#CA3B2A] transition-colors duration-200 font-body">
