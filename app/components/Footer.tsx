...
export default function Footer({ footer }: FooterProps) {
  ...
  if (!footer) {
    return (
      <footer className="bg-[#F8F6F3] py-12">
        <div className="container mx-auto px-6">
          <div className="text-center">
            <p className="font-header text-xl font-bold text-[#CA3B2A]">Kersten Talent Capital</p>
            <p className="mt-4 text-[#3D3939]">© {new Date().getFullYear()} Kersten Talent Capital. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
  ...
  return (
    <footer className="bg-[#F8F6F3] py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-[#3D3939] text-lg max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          {footer.columns?.map((column) => (
            <div key={column.id} className="md:col-span-2 py-2 md:py-0 ">
              ...
              <h4
                className="w-full flex justify-between items-center text-left font-header text-3xl font-bold text-[#3D3939] px-3 mb-1 md:px-0 md:py-0 md:mb-4 hover:bg-[#F0EDE8] hover:text-[#CA3B2A] rounded-md transition-colors md:hover:bg-transparent"
                  ...
                  {column.links?.map((link) => (
                    <li key={link.id}>
                      <Link
                        ...
                        className="block py-3 px-3 md:px-0 md:py-2 text-[#3D3939] md:text-[#3D3939] hover:text-[#CA3B2A] transition-colors duration-200 font-body text-lg hover:pl-5 md:hover:pl-0"
          ...
          <div className="md:col-span-4 md:ml-8">
            <h3 className="font-header text-4xl font-bold text-[#3D3939] mb-6">
              Get In Touch
            </h3>
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <a href="mailto:michael@kerstentalentcapital.com" className="text-[#3D3939] hover:text-[#CA3B2A] transition-colors duration-200 font-body">
              ...
              <li className="flex items-start space-x-3">
                ...
                <a href="tel:+13035241199" className="text-[#3D3939] hover:text-[#CA3B2A] transition-colors duration-200 font-body">
                  +1 (303) 524-1199
                </a>
              </li>
              <li className="flex items-start space-x-3">
                ...
                <address className="text-[#3D3939] not-italic font-body">
              ...
              <li className="flex items-start space-x-3">
                ...
                <a href="https://linkedin.com/in/kerstentalentcapital" target="_blank" rel="noopener noreferrer" className="text-[#3D3939] hover:text-[#CA3B2A] transition-colors duration-200 font-body">
        ...
        <div className="mt-16 pt-8 border-t border-[#E8E3DD]">
          <div className="text-center">
            <p className="text-[#3D3939] mb-4">
              © {new Date().getFullYear()} Kersten Talent Capital. All rights reserved.
            </p>
            <div className="flex justify-center space-x-6">
              <a href="#" className="text-[#3D3939] hover:text-[#CA3B2A] transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="text-[#3D3939] hover:text-[#CA3B2A] transition-colors duration-200">
                Terms of Service
