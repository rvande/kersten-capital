...
export default function Header({ global }: HeaderProps) {
  ...
  return (
    <>
      {/* Top Blue Bar */}
      <div className="w-full bg-[#002C5F] text-white text-sm font-bold md:text-md font-montserrat flex flex-wrap justify-center items-center px-3 sm:px-4 md:px-4 py-1 sm:py-1 border-b-2 border-[#0C6BAF] gap-4 sm:gap-3 md:gap-6 fixed top-0 left-0 right-0 z-[60]">
        ...
        <a href="tel:+13037216131" className="flex items-center gap-2 sm:gap-1 hover:text-[#71C8F3] transition-colors md:pr-6 lg:pr-10 whitespace-nowrap">
        ...
        <a href="/portal" className="flex items-center gap-2 sm:gap-1 hover:text-[#71C8F3] transition-colors md:pr-6 lg:pr-10 whitespace-nowrap">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V4a2 2 0 10-4 0v1.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
          Portal
        </a>
      </div>
