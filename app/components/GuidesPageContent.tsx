            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-10 shadow-2xl max-w-4xl mx-auto mb-16 border border-gray-200">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
                ...
                <div className="relative">
                  ...
                  <svg className="absolute right-3 md:right-3 top-1/2 transform -translate-y-1/2 text-white h-6 w-6 md:h-5 md:w-5 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24" role="presentation" aria-hidden="true">
