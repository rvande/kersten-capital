...
export default function SearchBar({ 
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      case 'blog':
        return (
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" role="presentation">
    ...
    <div ref={searchRef} className={`relative ${className}`}>
      <div className="relative">
        ...
        <button
          ...
          type="button"
        >
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" role="presentation">
